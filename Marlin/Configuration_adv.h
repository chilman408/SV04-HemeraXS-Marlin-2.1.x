 ...
 */
#define FAN_KICKSTART_TIME  480  // (ms) HC EHR Enabled and Changed from 100 to 480
#define FAN_KICKSTART_POWER 230  // 64-255 HC EHR Enabled and Changed from 180 to 230
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0 }    // HC EHR Changed to 0 (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.15        // (mm) Compression length applying to all extruders
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define ALLOW_LOW_EJERK       // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends HC EHR enabled
